"""
Django settings for AdOptimizer project.
...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-Z44Bgc96U3qIDYISEq4IoZv8ZP69xJzOsStLFoXu")
...
WSGI_APPLICATION = "adoptimizer.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="adoptimizer"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "adoptimizer_language"
LANGUAGES = [
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="cbpoot@gmail.com")
...
EMAIL_SUBJECT_PREFIX = "[AdOptimizer] "
...
ASGI_APPLICATION = "adoptimizer.asgi.application"
CHANNEL_LAYERS = {
    "default": {
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("AdOptimizer"),
    "URL": "http://localhost:8000",
    "DESCRIPTION": gettext_lazy("Save costs on your Ad spend."),  # noqa: E501
    "IMAGE": "https://upload.wikimedia.org/wikipedia/commons/2/20/PEO-pegasus_black.svg",
    "KEYWORDS": "SaaS, django",
    "CONTACT_EMAIL": "cbpoot@gmail.com",
}

# set this to True in production to have URLs generated with https instead of http
USE_HTTPS_IN_ABSOLUTE_URLS = env.bool("USE_HTTPS_IN_ABSOLUTE_URLS", default=False)

ADMINS = [("Bas", "cbpoot@gmail.com")]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "adoptimizer": {
            "handlers": ["console"],
            "level": env("ADOPTIMIZER_LOG_LEVEL", default="INFO"),
        },
    },
}
